...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Light of the Party - Communist Red & Gold Theme
        party: {
          red: {
            50: '#fef2f2',
            100: '#fee2e2',
            ...
            300: '#fca5a5',
            400: '#f87171',
            500: '#B22222', // Primary Party Red (Huyết)
            600: '#ac0705', // Vietnam Red
            700: '#8b1a1a', // Deep Red
            800: '#7f1d1d',
            900: '#450a0a',
          },
      ...
      boxShadow: {
        'party': '0 4px 14px 0 rgba(178, 34, 34, 0.39)',
        'party-lg': '0 10px 25px -3px rgba(178, 34, 34, 0.3), 0 4px 6px -2px rgba(178, 34, 34, 0.15)',
        'gold': '0 4px 14px 0 rgba(255, 215, 0, 0.39)',
        'gold-lg': '0 10px 25px -3px rgba(255, 215, 0, 0.3), 0 4px 6px -2px rgba(255, 215, 0, 0.15)',
      },
      backgroundImage: {
        'party-gradient': 'linear-gradient(135deg, #B22222 0%, #d32f2f 50%, #ac0705 100%)',
        'party-gradient-radial': 'radial-gradient(ellipse at center, rgba(139, 26, 26, 0.3) 0%, transparent 70%)',
